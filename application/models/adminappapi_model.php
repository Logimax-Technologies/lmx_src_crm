...
{ 
	...
	function isValidLogin($data)
	{
		...
		$record = array();
		$sql="Select e.enable_chit_collection,e.id_employee, e.active,'EMP' as login_type,if(e.emp_code is not null AND e.emp_code != '',e.emp_code,NULL) as emp_code,b.name as branch_name,id_profile,e.id_employee,e.firstname,e.lastname,e.mobile,e.email,ifnull(e.login_branches,'0') as id_branch,e.image, e.is_lmx 
		From employee e 
