                    ...
                    {           
...

                                {
                                    ...
                                    row += '<tr id="'+rowId+'">'
										...
										+'<td><div class="wastage" style="display:none">'+data[0].retail_max_wastage_percent+'</div><input type="number" name="est_tag[wastage][]" class="form-control wastage_max_per" value='+data[0].retail_max_wastage_percent+' style="width:100px;" /></td>'

										+'<td><div class="act_wast_wt" style="display:none">'+wast_wgt+'</div><input type="number" name="est_tag[est_wastage_wt][]" class="form-control est_wastage_wt" value="" style="width:100px;" /></td>'
										...
										+'<td><div class="mc_val" style="display:none">'+data[0].tag_mc_value+'</div><input class="form-control act_mc_value"  name="est_tag[mc][]" type="number" value='+data[0].tag_mc_value+' style="width:100px;" /><input class="discount_amount"  name="est_tag[discount_amount][]" type="hidden" value="" />Tot Mc:<span class="tot_mc" ></span></td>'
...
//gross wt
	...
	$("#est_print").click(function() {
	    ...
	    if(ask_cus_data && ask_branch && ask_emp_data && form_validate_tag && form_validate_nontag && form_validate_custom && form_validate_old)
...

{
    ...
    $.each(section_details, function (key, item) {  
        ...
        if($('#id_branch').val()==item.id_branch)
			...
			{  
		  	...
		  	$.each(data.tag_details.item_details,function(key,item){
				...
				var select_emp = "";
								...
								+'<td><input class="est_tag_name" type="text" name="est_tag[tag_name][]" value='+item.tag_code+' placeholder="Enter tag code" required autocomplete="off"/><input class="est_tag_id" type="hidden" name="est_tag[tag_id][]"  value='+item.tag_id+' placeholder="Enter tag code" required /><input class="rate_field" type="hidden"  value="'+item.rate_field+'"/></td>'
									...
									+'<td><div class="wastage" style="display:none">'+item.wastage_percent+'</div><input type="number" name="est_tag[wastage][]" class="form-control wastage_max_per" value='+item.wastage_percent+' style="width:100px;"/></td>'

									+'<td><div class="est_wastage_wt" style="display:none"></div><input type="number" name="est_tag[est_wastage_wt][]" class="form-control est_wastage_wt" value='+item.wastage_percent+' style="width:100px;" /></td>'
									...
									+'<td><div class="mc_val" style="display:none">'+item.mc_value+'</div><input class="form-control act_mc_value" type="number" value="'+item.mc_value+'"  name="est_tag[mc][]" /><input class="discount_amount"  name="est_tag[discount_amount][]" type="hidden" value="" />Tot Mc:<span class="tot_mc" ></span></td>'
