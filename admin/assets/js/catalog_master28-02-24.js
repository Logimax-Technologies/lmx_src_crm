							...
							oTable = $('#weight_list').dataTable({
									...
									"aoColumns": [
													...
													{ "mDataProp": function ( row, type, val, meta ) {
														 ...
														 action_content='<a href="'+edit_url+'" class="btn btn-primary"  role="button" data-toggle="modal" data-id='+id+' ><i class="fa fa-edit" ></i></a> <a href="#" class="btn btn-danger btn-del" data-href='+delete_url+' data-toggle="modal" data-target="#confirm-delete" ><i class="fa fa-trash"></i></a>'
...

			 {
				...
				oTable = $('#payment_list').dataTable({
						...
						{ "mDataProp": function ( row, type, val, meta ){
                        	...
                        	active_url =base_url+"index.php/admin_ret_catalog/ret_pay_device/update_status/"+row.id_device+"/"+(row.status==0?1:0);
...

			 {
				...
				oTable = $('#accounthed_list').dataTable({
						...
						{ "mDataProp": function ( row, type, val, meta ){
                        	...
                        	active_url =base_url+"index.php/admin_ret_catalog/ret_account/update_status/"+row.id_acc_head+"/"+(row.status==0?1:0);
...

			 {
				...
				oTable = $('#stock_list').dataTable({
						...
						{ "mDataProp": function ( row, type, val, meta ){
                        	...
                        	active_url =base_url+"index.php/admin_ret_catalog/stock_issue_type/update_status/"+row.id_stock_issue_type+"/"+(row.status==0?1:0);
    ...
    return $.ajax({
...

        {
			...
			if(wastage.type == 1){
				...
				$('#wastage_type_fixed').prop('checked', true);
...
$("#day_close_dynamic").on('click', function () {
	...
	if ($("input[name='id_branch[]']:checked").val()) {
		...
		var answer = window.confirm("Are You Sure want to Day Close For Selected Branch..?");
