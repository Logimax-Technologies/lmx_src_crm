	...
	*/
	...
	public function authenticate_post()
	{
		...
		if ($device_id != "" && $username != '' && $userpwd != '')
		{
			...
			$has_device = $this->$model->check_device_exists($username, $device_id);
			...
			{
				$result=array('result'=> FALSE ,'msg'=>'Your device not registered. Please contact administrator.');
				$this->response($result, 200);
			}
		}
		else
						...
						if($other_metal_details) {
							...
							foreach($other_metal_details as $oth_m) {
								...
								$est_other_metals=array(
									...
									'tag_other_itm_tag_id'      =>$oth_m['tag_other_itm_tag_id'],
