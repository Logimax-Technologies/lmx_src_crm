...

{
						...
						if (!empty($estCatalog)) {
							...
							foreach ($estCatalog['pro_id'] as $key => $val) {
								...
								$arrayEstCatalog = array(
									...
									'item_emp_id'          => ($estCatalog['item_emp_id'] != '' ? $estCatalog['item_emp_id'] : $addData['created_by']),
						...
						if (!empty($estCustom)) {
							...
							foreach ($estCustom['pro_id'] as $key => $val) {
								...
								$arrayEstCustom = array(
									...
									'item_emp_id'          => ($estCustom['item_emp_id'] != '' ? $estCustom['item_emp_id'] : $addData['created_by']),
						...
						if (!empty($estCatalog)) {
							...
							foreach ($estCatalog['pro_id'] as $key => $val) {
								...
								$arrayEstCatalog = array(
									...
									'item_emp_id'          => ($estCatalog['item_emp_id'] != '' ? $estCatalog['item_emp_id'] : $updateData['created_by']),
						...
						if (!empty($estCustom)) {
							...
							foreach ($estCustom['pro_id'] as $key => $val) {
								...
								$arrayEstCustom = array(
									...
									'item_emp_id'          => ($estCustom['item_emp_id'] != '' ? $estCustom['item_emp_id'] : $updateData['created_by']),
	...
	function get_village() {
        ...
        $village_name = $this->input->post('village_name');
        $pincode = $this->input->post('pincode');
        $village_name = strtolower($village_name);
        
        $this->db->select('*');
        $this->db->from('village');
        $this->db->where('LOWER(village_name)', $village_name);
        $query = $this->db->get();
	...
	function pan_available()
	{
		...
		$data = $this->$model->pan_available($_POST['pan_number']);
	...
	function gst_available()
	{
		...
		$data = $this->$model->gst_available($_POST['gst_number']);
	...
	function aadhar_available()
	{
		...
		$data = $this->$model->aadhar_available($_POST['aadhar_number']);
