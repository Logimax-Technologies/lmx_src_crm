...
class Ret_estimation_model extends CI_Model
{
	...
	*/
    ...
    function getCustomerDet($id_branch='',$id_customer)
	{
        ...
        WHERE c.id_customer=".$id_customer."  and b.fin_year_code=".($financial_year['fin_year_code'])."
 ...
 function get_old_metal_types()
    ...
    public function pan_available($pan_number)
	{
		$this->db->select('pan');
    ...
    public function gst_available($gst_number)
	{
    ...
    public function aadhar_available($aadhar_number)
	{
