            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="btn btn-success pull-right" id="add_dpt" href="#" data-toggle="modal"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="text" class="form-control" id="department" title="Only Alphabets and Space Allowed"
                name="department" value="<?php echo set_value('department', (isset($dept) ? $dept : "")); ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="text" class="form-control" id="ed_dept" title="Only Alphabets and Space Allowed"
                name="department" value="<?php echo set_value('department', (isset($dept) ? $dept : "")); ?>"
                                placeholder="Enter Department">
                            <p class="help-block"></p>
                        </div>
