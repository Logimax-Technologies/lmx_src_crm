						...
						<div class="col-md-12">
						    ...
						    <div class="row">
							    ...
							    <div class="col-sm-3 stone_type"  > 
									...
									<p class="help-block"></p>
					    				<input type="radio" id="stone_type0" name="product[stone_type]" value="0" <?php echo $product['stone_type'] == 0? 'checked="true"':''; ?>> <label class="custom-label" for="stone_type0"> Oranments</label>
					    				&nbsp;&nbsp;&nbsp;
