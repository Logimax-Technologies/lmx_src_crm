                  ...
                  <table id="emp_list" class="table grid table-bordered table-striped text-center">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th>Enable Device(Chit)</th>

                        <th>Enable Device(Estimation App)</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Enable Chit Employee</h4>

      </div>

      <div class="modal-body">

      <?php echo form_open("employee/enable_chit") ?>
         	...
         	<div class="">
         			 ...
         			 <div class="row">
                       ...
                       <div class="col-md-6">
                          ...
                          <input type="hidden" name="enable_chit[id_employee]" id="employee_id">
              ...
              <div class="row">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="hidden" class="form-control" id="device_uuid" name="enable_chit[uuid]" > 
              ...
              <!-- <div class="row">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" id="device_uuid" name="enable_chit[uuid]" placeholder="UUID" autocomplete="off" required> 
              ...
              <div class="row">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-1">
                            ...
                            <input type="checkbox" id="enable_device" name="enable_chit[enable_device]" <?php if($employees['enable_chit_collection']==1){?>checked="true" <?php } ?> value="1" >
                           ...
                           <div class="col-md-1">
                            ...
                            <input type="checkbox" id="enable_estimation_device" name="enable_chit[enable_estimation_device]" <?php if($employees['enable_estimation_app']==1){?>checked="true" <?php } ?> value="1" >
