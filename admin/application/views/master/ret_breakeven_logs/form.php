        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Breakeven Logs - <?php echo ( $paymode['id_mode']!=NULL?'Edit' :'Add'); ?></h3>
				...
				<?php echo form_open((  $paymode['id_mode']!=NULL &&  $paymode['id_mode']>0 ?'settings/paymode/update/'.$paymode['id_mode']:'settings/paymode/save')) ?>
				 <div class="row">
				 	<div class="form-group">
                       ...
                       <div class="col-md-4">
						<input type="text" class="form-control" id="mode_name" name="paymode[mode_name]" onkeypress="return /^[a-zA-Z ]$/i.test(event.key)" value="<?php echo set_value('paymode[mode_name]',$paymode['mode_name']); ?>" placeholder="eg: Credit Card" required="true">                  
