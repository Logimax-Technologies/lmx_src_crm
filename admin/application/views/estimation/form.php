      									...
      									<div class="form-group">
      										<div class="input-group " style="width: 100%;">
      											...
      											<span class="input-group-btn">
      												<button type="button" data-bs-toggle="offcanvas" data-bs-target="" id="add_new_customer" class="btn btn-success"><i class="fa fa-plus"></i></button>
      											</span>
      											<span class="input-group-btn">
      													...
      													<table id="total_summary_details" class="table table-bordered table-striped text-center">
      														...
      														<tbody>
      															<tr>
      																...
      																<td><span class="summary_lbl taxable_sale_smt"></span></td>
      															</tr>
      															<tr>
      																<td></td>
      																<td><span class="summary_lbl "></span></td>
      																<td>CGST</td>
      																<td><span class="summary_lbl tax_cgst"></span></td>
      															</tr>
      															<tr>
      																<td></td>
      																<td><span class="summary_lbl "></span></td>
      																<td>SGST</td>
      																<td><span class="summary_lbl tax_sgst"></span></td>
      															</tr>
      															<tr>
      																<td></td>
      																<td><span class="summary_lbl "></span></td>
      																<td>IGST</td>
      																<td><span class="summary_lbl tax_igst"></span></td>
      															</tr>
      															<tr>
