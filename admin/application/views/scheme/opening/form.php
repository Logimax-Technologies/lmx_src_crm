						...
						<div class="col-md-3" >
              				...
              				<div class="col-md-3" id="get_amt" style="display: none;">
								...
								<div class="form-group">
									...
									<input type='number' class='form-control width50' name="scheme[firstPayment_amt]" placeholder='Payment Amount' <?php echo ($scheme['total_paid_ins'] > 0 && !empty($scheme['firstPayment_amt'])) ? 'disabled' : ''; ?> id='firstPayment_amt' required='true'   value="<?php echo set_value('scheme[firstPayment_amt]',$scheme['firstPayment_amt']); ?>"/>
              				...
              				<div class="col-md-3 col-xs-12" >
                                ...
                                <input type='text' class='form-control width50' name="scheme[pan_no]" minlength='10' maxlength='10' placeholder='PAN Number' id='pan_no' value="<?php echo set_value('scheme[pan_no]',$scheme['pan_no']); ?>"  oninput="this.value = this.value.toUpperCase()"/>
