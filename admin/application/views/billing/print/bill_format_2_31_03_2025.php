					...
					<td>
						<div class="content-block">
							...
							<div style="width:100%;" class="new_tax">
								<div style="text-decoration: underline; text-align:center;"> <?php echo ($billing['is_eda']==1 ? '' : 'Proforma' )?> </div>
														...
														<table id="pp" class="table">
															<thead style="text-transform:uppercase;font-size:12px;">
																...
																<tr>
																	...
																	<th class="table_heading alignRight" style="width: 4%;">PCS</th>
																	<th class="table_heading alignRight" style="width: 9%;">GRS.WT</th>
																	<th class="table_heading alignRight" style="width: 9%;">NET.WT</th>
										...
										<table id="pp" class="table text-center">
											...
											if ($pur_total_amt == 0) {
												...
												<?php if ($tot_sales_amt + $billing['handling_charges'] > 0) { ?>
													<tr>
														<td colspan="5"></td>
														<td colspan="3" class="alignRight">Sales Amount</td>
														<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
						...
						<?php if (sizeof($est_other_item['old_matel_details']) > 0) { ?>
							...
							<table id="pp" class="table text-center">
								...
								<tr style="text-transform:uppercase;font-size:12px;">
									...
									<th class="table_heading alignRight" style="width: 8%;">PURITY</th>
								...
								?>
									<tr>
										<td class="alignCenter" style="width: 5%"><?php echo $i; ?>
									</td>
										<td style="font-size:10px; width:35%" colspan="2" class='textOverflowHidden'><?php echo $items['old_metal_type']; ?>
									</td>

									<td style="width:24%" style="width:8%" class="alignRight">
										<?php echo number_format($items['purity'], 2, '.','');?>
									</td>
										<td style="width: 24%" style="width: 8%" class="alignRight">
											<?php echo number_format($items['gross_wt'], 3, '.', ''); ?>
										</td>
										<td style="width: 10%" class="alignRight"><?php echo $items['stone_wt'] > 0 ? $items['stone_wt'] : ''; ?>
									</td>
										...
										<td style="width: 12%" class="alignRight"><?php echo moneyFormatIndia(number_format($items['amount'], 2, '.', '')); ?>
									</td>
									</tr>
								<?php $i++;
								} ?>
								...
								<?php if ($total_return > 0) { ?>
									<tr style="font-weight: bold">
										<td colspan="4"></td>
										<td class="alignRight" colspan="3">Exchange Amount</td>
										<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
										<td class="alignRight"><?php echo moneyFormatIndia(number_format($total_return, 2, '.', '')); ?></td>
									</tr>
								<?php } ?>
								<?php if ($pur_total_amt > 0) { ?>
									<tr style="font-weight:bold;">
										...
										<td class="alignRight" colspan="4">Purchase Amount</td>
										<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
...
<br>
	<?php if ($billing['bill_emp_name'] != '') { ?>
		<div style="font-weight:bold;">
		<?php echo 'Billed Emp : ' . $billing['bill_emp_name'] . '/' . $billing['bill_emp_code'] . ($billing['counter_name'] != ''?' -&nbsp;' . $billing['counter_name'] : '') ?>
		</div>
	<?php } ?>
