...
<body>
															...
															<tbody>
																...
																?>
																	...
																	<tr>
																		...
																		<td style="text-align:left;" class="textOverflowHidden"><?php echo ($items['is_delivered']==0 ? '*':'')?><?php echo $items['product_name']; ?><?php echo ' - ' . $items['design_name']; ?></td>
	...
	<?php if ($due_amount != 0) { ?>
		<tr>
			<td colspan="5"></td>
			<th colspan="2" class="alignRight">DUE AMOUNT<?php echo " (".$billing['credit_due_date'].")"?></th>
			<th class="alignRight" style="font-size:15px !important;">&#8377;</th>
