						...
						<?php if ($billing['billing_for'] == 1 || $billing['billing_for'] == 2) { ?>
							...
							<div id="headertable" style="display: inline-block;vertical-align:top;padding-left:0px;">
								...
								<table style="width:100%;line-height:-6px !important;font-weight:bold;">
									...
									<?php } ?>
									<?php if ($billing['driving_license_no'] != '') { ?>
									<tr>
											...
											<div class="col-xs-12">
												<div class="table-responsive">
													<table id="pp" class="table text-center">
														<thead style="text-transform:uppercase;font-size:19px;">
															<tr>
																...
																<td class="table_heading" style="width: 15%;">Description</td>
																<!-- <td class="table_heading" style="width: 9%">PURITY</td> -->
																<td class="table_heading alignRight" style="width: 6%;">Qty</td>
																<td class="table_heading alignRight" style="width: 10% !important;">Gwt</td>
																<td class="table_heading alignRight" style="width: 10% !important;">Lwt</td>
																<td class="table_heading alignRight" style="width: 10%; ">Calc.Wt</td>
																<td class="table_heading alignRight" style="width: 10%;">Rate</td>
																<td class="table_heading alignRight" style="width: 10%;">V.A</td>
														...
														<tr class="total" style="font-weight: bold">
															...
															<td class="alignRight"><?php echo number_format($less_wt, 3, '.', ''); ?></td>
															...
															<table id="pp" class="table text-center">
																<?php foreach ($est_other_item['order_adj'] as $ord) {
																	...
																	<tr style="display: none;">
																		<td colspan="7" style="font-weight: bold; width: 66%;">
																...
																<?php if ($pur_total_amt > 0) { ?>
																	<?php foreach ($est_other_item['old_matel_details'] as $items) { ?>
																		<tr>
																			<td colspan="7" style="font-weight: bold; width: 66%;">By Puq Rec.No:<?php echo $items['pur_refId'] . ($billing['fin_year_code'] != '' ? " (" . $billing['fin_year_code'] . ")" : ''); ?></td>
													...
													<?php } ?> -->
																...
																<?php if ($round_off != 0) { ?>
																	<tr>
																		<td colspan="7" style="width: 66%;"></td>
																		<td class="alignLeft">Round Off</td>
																		<td class="alignLeft">Rs.</td>
