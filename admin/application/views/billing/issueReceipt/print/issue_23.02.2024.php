 ...
 <div class="box">
  <div class="box-body">
    										...
    										<tbody>
    											...
    											<tr>
    												...
    												<?php }else if($issue['type']==1){?>
    												    ...
    												    {?>
    												        <td colspan="7" style="text-transform:uppercase;"><?php echo 'Petty Cash Issue';?></td>
		...
		<div class="footer">
			...
			<div style="font-size:16px; text-align:Right;width:48%;">For GUPTHA GEM JEWLLERS</div>
