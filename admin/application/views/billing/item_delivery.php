      ...
      <div class="col-xs-12">
         <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Item Delivery List</h3>  <span id="total_billing" class="badge bg-green"></span>  
          </div>
           <div class="box-body">
                  <?php 
                 ...
                 <div class="box-body">  
                     <div class="row">
                          ...
                          <div class="col-md-2"> 
                              ...
                              <div class="form-group">
                              <?php if($access['add']==1){?>
                                  <button type="button" id="item_deliver" class="btn btn-info">Deliver</button>   
                                  <?php }?>
                                </div>
                          </div>
                      </div>
