...
@keyframes shadowPulse {
  ...
  100% {
											...
											<div class="col-md-3">
												...
												<div class="input-group">
													...
													<span class="input-group-btn">
														<a class="btn btn-default" id="add_new_customer" data-bs-toggle="offcanvas" data-bs-target="" href="#" data-toggle="tooltip" title="Add Customer" tabindex=5><i class="fa fa-user-plus"></i></a>
																		...
																		<tbody>
																			...
																			if (sizeof($modes) > 0) {
																				foreach ($modes as $mode) {
																					$cash = ($mode['short_code'] == "CSH" ? '<input class="form-control" id="make_pay_cash" name="billing[cash_payment]"  type="text" placeholder="Enter" autocomplete="off" Amount" value=""/>' : '');
	...
	<div class="modal fade" data-bs-backdrop="static" data-keyboard="false" id="order_otp_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel">Verify OTP and Update Status</h4>
	...
	<!-- old metals -->
	<div class="modal fade" id="credit_disc_otp_modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-backdrop="static" data-keyboard="false">
		<div class="modal-dialog">
			<div class="modal-content">
