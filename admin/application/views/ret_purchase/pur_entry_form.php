...

								{
									...
									$charges_details =json_encode($chargeData);
											...
											echo '<tr id="'.$ikey.'"">
												...
												<td><input type="hidden" class="tot_purewt" name="order_item[tot_purewt][]" value="'.$ival['item_pure_wt'].'"><input type="hidden" class="pur_calc_type" name="order_item[pur_calc_type][]" value="'.$ival['pure_wt_calc_type'].'">'.$ival['item_pure_wt'].'</td>
