                					...
                					<div class="col-md-2">
                	                     ...
                	                     <div class="form-group">
                	                       ...
                	                       <label>Select Karigar<span class="error">*</span></label>
                								...
                								<input type="hidden" id="rate_fix_type"  name="rate_fix[rate_fix_type]" value="1">
            				        ...
            				        <div class="col-md-3">
                	                     ...
                	                     <div class="form-group">
											...
											<div class="input-group">
													...
													<select id="select_po_ref_no" class="form-control" name="order[rate_fix_po_item_id]" style="width:150px;" tabindex="1"></select>
