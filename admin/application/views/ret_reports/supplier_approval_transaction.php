	   ...
	   <div class="box box-primary">
		 ...
		 <div class="box-body">  
				...
				<div class="box-header with-border">
				 ...
				 <div class="col-md-2">  <h3 class="box-title">Supplier Approval Ledger</h3> </div>
					...
					<div class="col-md-2"> 
						...
						<div class="form-group">    
							...
							?>
							   ...
							   <input type="text" class="form-control pull-right btn_date_range" id="dt_range" placeholder="From Date -  To Date" value="<?php echo $fromdt.' - '.$todt?>" readonly="">  
					 ...
					 <div class="col-md-2"> 
						 ...
						 <div class="form-group">
							 ...
							 <button type="button" id="supplier_approval_ledger_search" class="btn btn-info">Search</button>   
