  <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Reports
			 <small>Stock Age Analysis Dynamic</small>
          </h1>
          <ol class="breadcrumb">
                 ...
                 <div class="box-body">  
				  ...
				  <div class="col-md-offset-1 col-md-10">  
	                  <div class="box box-default">  
					   ...
					   <div class="row">
						  <div class="col-md-2"> 
		                     <label>Stock Age Day(s)</label> 
		                  </div>
		                  <div class="col-md-2"> 
		                     <div class="form-group">
							 <label>From</label> 
				                <input type="number" class="form-control" id="age_from" placeholder="From Day">
		                    </div>
		                  </div>
		                  <div class="col-md-2"> 
		                    <div class="form-group">
							 <label>To</label> 
				                <input type="number" class="form-control" id="age_to" placeholder="To Day">
		                    </div>
		                  </div>
		                  <div class="col-md-2"> 
		                    <label> </label>
		                    <div class="form-group">
				                <button type="button" id="stockAge_dynamic_search" class="btn btn-info pull-right">Search</button>   
		                    </div>
		                  </div> 
					   </div>
	                 ...
	                 <table id="stock_age_list" class="table table-bordered table-striped text-center">
	                    <thead>
						  <tr>
						    ...
						    <th width="5%">Age</th>  
						    <th width="5%">Piece</th>  
						    <th width="5%">Gross Wt (Gm)</th>  
						    <th width="5%">Net Wt (Gm)</th>  
